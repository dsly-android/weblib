...
public final class ToastUtils {
    ...
    private static void show(@StringRes final int resId, final int duration) {
        show(X5WebUtils.getApplication().getResources().getText(resId).toString(), duration);
    }

    private static void show(@StringRes final int resId, final int duration, final Object... args) {
        show(String.format(X5WebUtils.getApplication().getResources().getString(resId), args), duration);
    }
    ...
    private static void show(final CharSequence text, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = Toast.makeText(X5WebUtils.getApplication(), null, duration);
    ...
    private static void show(final View view, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = new Toast(X5WebUtils.getApplication());
                sToast.setView(view);
    ...
    private static View getView(@LayoutRes final int layoutId) {
        LayoutInflater inflate =
                (LayoutInflater) X5WebUtils.getApplication().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    private static final class ApplicationContextWrapperForApi25 extends ContextWrapper {
        ...
        ApplicationContextWrapperForApi25() {
            super(X5WebUtils.getApplication());
        }
